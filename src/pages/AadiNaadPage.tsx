...
const AadiNaadPage = () => {
  ...
  if (selectedProfile === 'dipanwita') {
    return (
      <div className="min-h-screen scroll-background">
        ...
        <div className="pt-28 px-4" style={{ height: 'calc(100vh - 6rem - 1rem)', overflowY: 'auto' }}>
  ...
  if (selectedProfile === 'subir') {
    return (
      <div className="min-h-screen scroll-background">
        <Navigation currentSection="naad" />
        <div className="pt-24 px-4" style={{ height: 'calc(100vh - 6rem - 4rem)', overflowY: 'auto' }}>
          <div className="max-w-4xl mx-auto">
            <button 
              onClick={() => setSelectedProfile(null)}
              className="flex items-center gap-2 mb-8 text-amber-800 hover:text-amber-900 transition-colors font-calibri"
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <div className="font-calibri">
                  ...
                  <p className="text-amber-800 text-base font-bold">
                    Director & Head of Music, <span className="calibri">A</span><span className="samarkan">adi</span><span className="calibri">G</span><span className="samarkan">en</span><span className="calibri">X</span>
                  </p>
                </div>
              </CardContent>
            </Card>
