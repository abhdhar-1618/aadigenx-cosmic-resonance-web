    ...
    <div className="min-h-screen scroll-background">
      ...
      <div className="pt-24 pb-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-12 text-center bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
              ...
              >
                ...
                <div className="px-16 py-12 relative z-10">
                  ...
                  <div className="text-center mb-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-amber-900 mb-2 font-cinzel">
                  ...
                  <div className="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <div className="lg:w-2/3">
                      <h3 className="text-2xl font-bold text-amber-900 mb-4 font-cinzel">
                        Dipanwita DasChakrabarty
                      </h3>
                      
                      <div className="space-y-4 text-amber-900 font-crimson">
                    ...
                    <div className="lg:w-1/3 flex justify-center">
                      <div className="relative">
                        <img 
                          src="/lovable-uploads/1c432f51-cfd4-4aad-83a0-0fd335adae46.png"
                          alt="Dipanwita DasChakrabarty"
                          className="w-48 h-64 object-cover rounded-lg shadow-lg border-4 border-amber-800"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="absolute bottom-2 right-8">
                  <div className="w-8 h-8 bg-amber-900 rounded-full shadow-inner flex items-center justify-center">
