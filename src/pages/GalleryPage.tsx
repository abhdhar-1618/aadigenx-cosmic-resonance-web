...
// Custom Navigation Component for GalleryPage
  ...
  return (
    <div className="min-h-screen scroll-background">
      ...
      <div className="pt-16 pb-20 px-4 md:px-8">
        <div className="min-h-screen bg-amber-800/20 backdrop-blur-sm rounded-2xl border border-amber-600/30 shadow-2xl">
          <GallerySection />
        </div>
      </div>
