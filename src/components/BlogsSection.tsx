  ...
  const blogPosts = [
    {
      ...
      content: [
        ...
        "At AadiGenX, we believe that the future lies not in abandoning our roots, but in harmoniously integrating ancient wisdom with cutting-edge innovation. The Sanskrit term 'Aadi' meaning 'beginning' or 'origin' combined with 'GenX' representing the next generation, embodies this philosophy perfectly.",
